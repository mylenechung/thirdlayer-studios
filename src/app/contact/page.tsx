    ...
    <div style={{ background: C.beige, minHeight: '100vh' }}>
      <section style={{ padding: mob ? '80px 24px 60px' : '120px 48px 100px', background: C.dark }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-righteous),cursive', fontSize: 'clamp(48px,7vw,80px)', lineHeight: 1.0, color: C.beige, maxWidth: 680, margin: 0 }}>
          Start a project<br />with us.
        </h1>
      </section>

      <section style={{ padding: mob ? '48px 24px 64px' : '80px 48px 120px', display: 'grid', gridTemplateColumns: mob ? '1fr' : '1fr 1fr', gap: mob ? 48 : 120, alignItems: 'start' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 36 }}>
          ...
          <button style={{ background: C.accent, border: 'none', padding: '16px 40px', alignSelf: 'flex-start', color: C.beige, fontFamily: 'var(--font-dm-sans),sans-serif', fontSize: 12, letterSpacing: '0.12em', textTransform: 'uppercase', cursor: 'pointer', fontWeight: 500 }}>
            Send Enquiry
          </button>
        </div>
        ...
        <div>
          <div style={{ marginBottom: 48 }}>
            ...
            <a href="mailto:hello@thirdlayer_studios.com" style={{ fontFamily: 'var(--font-dm-sans),sans-serif', fontSize: 18, color: C.dark, textDecoration: 'none' }}>hello@thirdlayer_studios.com</a>
          </div>
          <div style={{ marginBottom: 48 }}>
            <SectionLabel>Instagram</SectionLabel>
            <a href="https://instagram.com/thirdlayer_studios" target="_blank" rel="noopener noreferrer" style={{ fontFamily: 'var(--font-dm-sans),sans-serif', fontSize: 18, color: C.dark, textDecoration: 'none' }}>@thirdlayer_studios</a>
          </div>
          <div style={{ padding: '32px 36px', borderLeft: `2px solid ${C.accent}`, background: 'rgba(20,20,20,0.03)' }}>
            <p style={{ fontFamily: 'var(--font-dm-sans),sans-serif', fontSize: 14, lineHeight: 1.85, color: C.body, margin: 0 }}>
              We&apos;re currently open to new brand partnerships. Whether you&apos;re launching a campaign, refreshing product imagery, or exploring AI-assisted production for the first time — reach out and let&apos;s talk.
            </p>
          </div>
        </div>
      </section>
